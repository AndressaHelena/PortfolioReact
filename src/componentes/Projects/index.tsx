    ...
    return (
        <section id="projetos" className="dark-bg about-text">
            ...
            <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green">Agendamento</h3>
                ...
                <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green">Revelar seu destino</h3>
                ...
                <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green">Nutricionista</h3>
                ...
                <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green">Frases Biblicas</h3>
                ...
                <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green">Decodificador de texto</h3>
                        <h4 className="gray">Challenge Alura com HTML, CSS e JavaScript.</h4>
                ...
                <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green ">Sistema Financeiro</h3>
                ...
                <li className="flex">
                    ...
                    <div className="dados">
                        <h3 className="title green">Agendamento Médico</h3>
